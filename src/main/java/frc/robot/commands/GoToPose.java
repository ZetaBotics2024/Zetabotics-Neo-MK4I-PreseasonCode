...
public class GoToPose extends CommandBase {
    ...
    private FollowPathWithEvents fullAuto;
    ...
    public void initialize() {
        PathPlannerPath path = PathPlannerPath.fromPathPoints(null, null, null);

        fullAuto = new FollowPathWithEvents(
            ...
            this.m_driveSubsystem// Reference to this subsystem to set requirements
            ),
            path, // FollowPathWithEvents also requires the path
            this.poseEstimatorSystem::getCurrentPose 
            );
    }
  }